...
class_0_label_ = Y_independent_label['class_0_indep_raw_data_label'][0, 0:LEN_VAL]
class_1_data_ = X_dependent_data['class_1_dep_raw_data'][0, 0:LEN_VAL]
class_1_label_ = X_dependent_label['class_1_dep_raw_data_label'][0, 0:LEN_VAL]

index = np.arange(0, LEN_VAL)
plt.figure(figsize=(10,10))
plt.plot(index, class_0_data_ , '-*k', markersize = 10, label = "Y(t)")
plt.plot(index, class_1_data_, '-or', label = "X(t)")
plt.xticks(fontsize=30)
plt.yticks(fontsize=30)
plt.grid(True)
...
plt.legend(fontsize = 30)
plt.tight_layout()
plt.savefig(RESULT_PATH_FINAL+"LZ-"+DATA_NAME+"coup_0.4.jpg", format='jpg', dpi=300)
plt.savefig(RESULT_PATH_FINAL+"LZ-"+DATA_NAME+"coup_0.4.eps", format='eps', dpi=300)
plt.savefig(RESULT_PATH_FINAL+"LZ-"+DATA_NAME+"coup_0.4.png", format='png', dpi=300)
plt.show()
