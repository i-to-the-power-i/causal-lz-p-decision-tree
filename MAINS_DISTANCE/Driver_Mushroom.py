...
y = pd.read_csv('MushroomTargets.csv')
...
#Saving
PATH = os.getcwd()
RESULT_PATH_TRAIN = PATH + '/DISTANCEMETRIC-TUNING/Mushroom/'
...
RESULT_PATH_TEST = PATH + '/DISTANCEMETRIC-TESTING/Mushroom/'

ACCURACY,F1_SCORE, PRECISION, RECALL = getTestResults(X_train, y_train, MIN_SAMPLES_SPLIT, MAX_DEPTH_TREE,X_test, y_test,'Mushroom',column_labels_list)
try:
