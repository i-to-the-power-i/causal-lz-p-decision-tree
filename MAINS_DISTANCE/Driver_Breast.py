...
X = pd.read_csv('Breast Cancer data.csv')
y = pd.read_csv('Breast Cancer target.csv')
...
#Saving
PATH = os.getcwd()
RESULT_PATH_TRAIN = PATH + '/DISTANCEMETRIC-TUNING/BreastCancer/'
...
RESULT_PATH_TEST = PATH + '/DISTANCEMETRIC-TESTING/BreastCancer/'

ACCURACY,F1_SCORE, PRECISION, RECALL = getTestResults(X_train, y_train, MIN_SAMPLES_SPLIT, MAX_DEPTH_TREE,X_test, y_test,'Wisconsin',column_labels_list)
try:
