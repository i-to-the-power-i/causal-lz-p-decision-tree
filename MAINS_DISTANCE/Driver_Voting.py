...
X = pd.read_csv('VotingData.csv')
y = pd.read_csv('VotingTargets.csv')
...
ACCURACY,F1_SCORE, PRECISION, RECALL = getTestResults(X_train, y_train, MIN_SAMPLES_SPLIT, MAX_DEPTH_TREE,X_test, y_test,'Voting',column_labels_list)
try:
