...
X = pd.read_csv('Chess.csv')
y = pd.read_csv('ChessTarget.csv')
...
#Saving
PATH = os.getcwd()
RESULT_PATH_TRAIN = PATH + '/DISTANCEMETRIC-TUNING/Chess/'
...
RESULT_PATH_TEST = PATH + '/DISTANCEMETRIC-TESTING/Chess/'

ACCURACY,F1_SCORE, PRECISION, RECALL = getTestResults(X_train, y_train, MIN_SAMPLES_SPLIT, MAX_DEPTH_TREE,X_test, y_test,'Chess',column_labels_list)
try:
