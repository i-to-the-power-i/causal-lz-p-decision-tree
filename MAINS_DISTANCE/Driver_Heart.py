...
y = pd.read_csv('HeartTargets.csv')
...
#Saving
PATH = os.getcwd()
RESULT_PATH_TRAIN = PATH + '/DISTANCEMETRIC-TUNING/Heart/'
...
RESULT_PATH_TEST = PATH + '/DISTANCEMETRIC-TESTING/Heart/'

ACCURACY,F1_SCORE, PRECISION, RECALL = getTestResults(X_train, y_train, MIN_SAMPLES_SPLIT, MAX_DEPTH_TREE,X_test, y_test,'Heart',column_labels_list)
try:
