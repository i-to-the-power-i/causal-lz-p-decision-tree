...
X = pd.read_csv('ARDATA.csv')
y = pd.read_csv('ARTARGETS.csv')
...
#Saving
PATH = os.getcwd()
RESULT_PATH_TRAIN = PATH + '/DISTANCEMETRIC-TUNING/AR/'
...
RESULT_PATH_TEST = PATH + '/DISTANCEMETRIC-TESTING/AR/'

ACCURACY,F1_SCORE, PRECISION, RECALL = getTestResults(X_train, y_train, MIN_SAMPLES_SPLIT, MAX_DEPTH_TREE,X_test, y_test,'AR',column_labels_list)
try:
